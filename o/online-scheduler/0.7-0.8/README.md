# Comparing `tmp/online_scheduler-0.7.tar.gz` & `tmp/online_scheduler-0.8.tar.gz`
...
## Comparing `online_scheduler-0.7.tar` & `online_scheduler-0.8.tar`
...
### Comparing `online_scheduler-0.7/online_scheduler/online_scheduler.py` & `online_scheduler-0.8/online_scheduler/online_scheduler.py`
...
### Comparing `online_scheduler-0.7/setup.py` & `online_scheduler-0.8/setup.py`
