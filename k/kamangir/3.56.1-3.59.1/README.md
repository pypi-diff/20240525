# Comparing `tmp/kamangir-3.56.1.tar.gz` & `tmp/kamangir-3.59.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "kamangir-3.56.1.tar", last modified: Sat May 25 01:31:42 2024, max compression
+gzip compressed data, was "kamangir-3.59.1.tar", last modified: Sat May 25 01:52:51 2024, max compression
```

## Comparing `kamangir-3.56.1.tar` & `kamangir-3.59.1.tar`

### file list

```diff
@@ -1,22 +1,22 @@
-drwxr-xr-x   0 kamangir   (502) staff       (20)        0 2024-05-25 01:31:42.975883 kamangir-3.56.1/
--rw-r--r--   0 kamangir   (502) staff       (20)     7048 2023-09-12 02:58:40.000000 kamangir-3.56.1/LICENSE
--rw-r--r--   0 kamangir   (502) staff       (20)       24 2024-05-20 04:50:43.000000 kamangir-3.56.1/MANIFEST.in
--rw-r--r--   0 kamangir   (502) staff       (20)     4179 2024-05-25 01:31:42.974904 kamangir-3.56.1/PKG-INFO
--rw-r--r--   0 kamangir   (502) staff       (20)     3281 2024-05-25 01:31:07.000000 kamangir-3.56.1/README.md
-drwxr-xr-x   0 kamangir   (502) staff       (20)        0 2024-05-25 01:31:42.969188 kamangir-3.56.1/kamangir/
--rw-r--r--   0 kamangir   (502) staff       (20)       94 2024-05-25 01:31:35.000000 kamangir-3.56.1/kamangir/__init__.py
--rw-r--r--   0 kamangir   (502) staff       (20)      581 2024-05-21 02:51:14.000000 kamangir-3.56.1/kamangir/__main__.py
--rw-r--r--   0 kamangir   (502) staff       (20)     4725 2024-05-25 01:28:19.000000 kamangir-3.56.1/kamangir/content.py
--rw-r--r--   0 kamangir   (502) staff       (20)     1943 2024-05-21 02:51:14.000000 kamangir-3.56.1/kamangir/functions.py
--rw-r--r--   0 kamangir   (502) staff       (20)       89 2024-05-21 02:51:14.000000 kamangir-3.56.1/kamangir/logger.py
--rw-r--r--   0 kamangir   (502) staff       (20)       17 2024-05-21 02:51:14.000000 kamangir-3.56.1/kamangir/urls.py
-drwxr-xr-x   0 kamangir   (502) staff       (20)        0 2024-05-25 01:31:42.973924 kamangir-3.56.1/kamangir.egg-info/
--rw-r--r--   0 kamangir   (502) staff       (20)     4179 2024-05-25 01:31:42.000000 kamangir-3.56.1/kamangir.egg-info/PKG-INFO
--rw-r--r--   0 kamangir   (502) staff       (20)      349 2024-05-25 01:31:42.000000 kamangir-3.56.1/kamangir.egg-info/SOURCES.txt
--rw-r--r--   0 kamangir   (502) staff       (20)        1 2024-05-25 01:31:42.000000 kamangir-3.56.1/kamangir.egg-info/dependency_links.txt
--rw-r--r--   0 kamangir   (502) staff       (20)      180 2024-05-25 01:31:42.000000 kamangir-3.56.1/kamangir.egg-info/requires.txt
--rw-r--r--   0 kamangir   (502) staff       (20)        9 2024-05-25 01:31:42.000000 kamangir-3.56.1/kamangir.egg-info/top_level.txt
--rw-r--r--   0 kamangir   (502) staff       (20)       81 2024-05-22 02:19:52.000000 kamangir-3.56.1/pyproject.toml
--rw-r--r--   0 kamangir   (502) staff       (20)      180 2024-05-25 01:29:17.000000 kamangir-3.56.1/requirements.txt
--rw-r--r--   0 kamangir   (502) staff       (20)       38 2024-05-25 01:31:42.976114 kamangir-3.56.1/setup.cfg
--rw-r--r--   0 kamangir   (502) staff       (20)      226 2024-05-22 02:20:30.000000 kamangir-3.56.1/setup.py
...
### Comparing `kamangir-3.56.1/LICENSE` & `kamangir-3.59.1/LICENSE`

 * *Files identical despite different names*

### Comparing `kamangir-3.56.1/PKG-INFO` & `kamangir-3.59.1/PKG-INFO`
...
@@ -36,8 +36,8 @@
 ...
 ---
-built by [`abcli-8.214.1-current`](https://github.com/kamangir/awesome-bash-cli), based on [`kamangir-3.55.1`](https://github.com/kamangir/kamangir).
...
### Comparing `kamangir-3.56.1/README.md` & `kamangir-3.59.1/README.md`
...
### Comparing `kamangir-3.56.1/kamangir/__main__.py` & `kamangir-3.59.1/kamangir/__main__.py`

 * *Files identical despite different names*

### Comparing `kamangir-3.56.1/kamangir/content.py` & `kamangir-3.59.1/kamangir/content.py`

 * *Files identical despite different names*

### Comparing `kamangir-3.56.1/kamangir/functions.py` & `kamangir-3.59.1/kamangir/functions.py`

 * *Files identical despite different names*

### Comparing `kamangir-3.56.1/kamangir.egg-info/PKG-INFO` & `kamangir-3.59.1/kamangir.egg-info/PKG-INFO`
