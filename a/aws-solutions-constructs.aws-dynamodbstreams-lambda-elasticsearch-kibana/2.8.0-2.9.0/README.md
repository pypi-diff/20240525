# Comparing `tmp/aws-solutions-constructs.aws-dynamodbstreams-lambda-elasticsearch-kibana-2.8.0.tar.gz` & `tmp/aws-solutions-constructs.aws-dynamodbstreams-lambda-elasticsearch-kibana-2.9.0.tar.gz`
