# Comparing `tmp/articraft-2.5.1.tar.gz` & `tmp/articraft-2.6.1.tar.gz`
...
## Comparing `articraft-2.5.1.tar` & `articraft-2.6.1.tar`
...
### Comparing `articraft-2.5.1/LICENSE` & `articraft-2.6.1/LICENSE`

 * *Files identical despite different names*

### Comparing `articraft-2.5.1/PKG-INFO` & `articraft-2.6.1/PKG-INFO`
...
### Comparing `articraft-2.5.1/README.md` & `articraft-2.6.1/README.md`

 * *Files identical despite different names*

### Comparing `articraft-2.5.1/articraft.egg-info/PKG-INFO` & `articraft-2.6.1/articraft.egg-info/PKG-INFO`
